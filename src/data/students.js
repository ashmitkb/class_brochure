...
export const students = [
  ...
  },
  {
    ...
    bio: "Full-Stack Developer and AI builder co-founding ventures in EdTech and FinTech. As Co-Founder & CTO of College Circle AI, architected a personalized learning platform reaching 200+ users and led a 10-member engineering team, while also building a 150+ member fintech education community and supporting AI research and dataset curation work.",
  ...
  },
  {
    id: 'stu-030',
    name: "Allen Pinto",
    photo: "students/stu-030.jpg",
    resumeFile: "resumes/stu-030.pdf",
    tagline: "Software developer & blockchain enthusiast",
    bio: "Software Developer with production experience across React, Node.js, and MongoDB/REST API design, having delivered multiple end-to-end applications with strong user engagement. Also brings over six years of independent experience analyzing Forex, commodities, and global currency markets, pairing technical development skills with a strong grounding in financial markets.",
    priorEducation: "Class XII, Christ King Pre-University College, Karkala",
  ...
  {
    id: 'stu-031',
    name: "Sri Harsha Pitani",
    photo: "students/stu-031.jpg",
    resumeFile: "resumes/stu-031.pdf",
    tagline: "Python developer & business analytics",
    bio: "Enthusiastic BCA student with hands-on experience in Python and web development gained through internships in automation and CRM analytics. Skilled in building AI-powered applications, automating workflows, and applying business analytics across financial modelling, market research, and consumer behaviour domains.",
    priorEducation: "Class XII, San Academy Group Of Schools, Chennai",
    technicalSkills: [ "Python", "SQL", "Microsoft Excel", "Power BI", "Tableau", "HTML", "CSS", "JavaScript" ],
    professionalSkills: ["Leadership", "Data Storytelling", "Problem Solving", "Cross-functional Collaboration", "Public Speaking"],
    projects: [
  ...
  {
    id: 'stu-032',
    name: "Charitha Venkatadri",
    photo: "students/stu-032.jpg",
    resumeFile: "resumes/stu-032.pdf",
    tagline: "Data analyst & full-stack developer",
    bio: "BCA student with experience in Python and data analysis, skilled at analyzing datasets and generating meaningful insights through academic and internship projects. Experienced across healthcare data reporting and full-stack web development, with a focus on delivering data-driven solutions that support business decision-making.",
    priorEducation: "Class XII, Widia Poorna Prajna School, Bengaluru",
  ...
  {
    id: 'stu-033',
    name: "Karthik Sankar R",
    photo: "students/stu-033.jpg",
    resumeFile: "resumes/stu-033.pdf",
    tagline: "Full-stack developer & UI/UX designer",
    bio: "Final-year BCA student with hands-on experience across backend logic, front-end development, mobile apps, and immersive 3D design with Blender and Unity. Brings a strong eye for design alongside a commitment to continuous learning, contributing to cohesive digital products from concept to completion.",
    priorEducation: "Class XII, Dayapuram Residential School, Kozhikode",
    technicalSkills: [ "Python", "SQL", "Microsoft Excel (Advanced)", "Power BI", "Tableau", "Tally Prime", "Figma", "Git", "HTML", "CSS", "JavaScript", "Flask", "Django", "Android Studio", "Unity", "Blender" ],
    professionalSkills: ["Leadership", "Data Storytelling", "Problem Solving", "Cross-functional Collaboration", "Public Speaking"],
    projects: [
      { title: "Waste Management System | Android Studio, Google API", desc: "Built an app for segregating locality waste through an integrated segregation system, including a real-time API and gamification features to boost engagement.", link: "" },
